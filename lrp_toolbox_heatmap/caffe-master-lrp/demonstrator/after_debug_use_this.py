...
from utils_change import lrp_opts,load_model,get_target_indices, cropped_imagenet_mean,split_into_batches, transform_input, lrp_hm, normalize_color_hm, process_raw_heatmaps
...
classind    =  0   #-1    #100          # (class index  | -1 for top_class)
