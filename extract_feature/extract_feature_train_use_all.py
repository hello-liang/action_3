...
def main():
    ...
    output_dir="result_all_train_by_all"
    ...
    PRETRAINED_FILE='/opt/data/action_3/model_all/Lq_loss_iter_5000.caffemodel'  #change model_1/pretrain/....
    TEST_DATA_FILE ='/opt/data/action_3/model_all/all_data.txt'  #
   #un comment if run all of data
    #TEST_DATA_FILE ='/opt/data/action_3/model_'+str(model_use)+'/test'+str(model_use)+'.txt'  #
