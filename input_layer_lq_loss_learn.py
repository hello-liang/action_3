...
def BatchAdvancer(idx, buffer_size):
    ...
    train_or_test = 'train'
    flow = False
    buffer_size = train_buffer  #num videos processed per batch
    frames = train_frames   #length of processed clip
    N = self.buffer_size*pair
    idx = 0
    channels = 12
    height = 227
    width = 227
    path_to_images = RGB_frames 
    video_list = 'all_data.txt' 
